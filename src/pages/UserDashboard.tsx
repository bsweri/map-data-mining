      ...
      <aside className={`h-screen w-64 fixed left-0 top-0 bg-surface-container-low border-r border-outline-variant flex flex-col py-6 z-50 transition-transform duration-300 ease-in-out md:translate-x-0 ${
        ...
        <nav className="mb-2">
          <div className="px-2 space-y-1">
            ...
            <Link onClick={() => setIsMobileSidebarOpen(false)} className={`${routerLocation.pathname === '/dashboard' ? 'bg-secondary-container text-on-secondary-container font-bold' : 'text-on-surface-variant hover:bg-surface-container-high'} duration-200 ease-in-out px-4 py-3 mx-2 flex items-center gap-3 rounded-lg font-inter text-sm font-medium`} to="/dashboard">
              <Compass size={18} />
              Dashboard
            </Link>
            <Link onClick={() => setIsMobileSidebarOpen(false)} className={`${routerLocation.pathname === '/pricing' ? 'bg-secondary-container text-on-secondary-container font-bold' : 'text-on-surface-variant hover:bg-surface-container-high'} duration-200 ease-in-out px-4 py-3 mx-2 flex items-center gap-3 rounded-lg font-inter text-sm font-medium`} to="/pricing">
              <CreditCard size={18} />
              Buy Credits
            </Link>
            <Link onClick={() => setIsMobileSidebarOpen(false)} className={`${routerLocation.pathname === '/affiliate' ? 'bg-secondary-container text-on-secondary-container font-bold' : 'text-on-surface-variant hover:bg-surface-container-high'} duration-200 ease-in-out px-4 py-3 mx-2 flex items-center gap-3 rounded-lg font-inter text-sm font-medium`} to="/affiliate">
              <Users size={18} />
              Affiliate
            </Link>
      ...
      <main className="md:ml-64 flex-grow min-h-screen flex flex-col transition-all duration-300">
        ...
        <header className="h-16 px-gutter flex items-center justify-between sticky top-0 bg-surface/80 backdrop-blur-md border-b border-outline-variant z-40">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-hanken text-lg font-bold text-on-surface">Dashboard</h2>
          </div>
